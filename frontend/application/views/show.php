            ...
            <div class="row">
              ...
              <div class="form-group row">
                <div class="offset-4 col-8">
                  <?php echo form_submit(['type' => 'submit', 'name' => 'update', 'class' => 'btn btn-primary', 'value' => 'Update']); ?>
                  <?php echo form_submit(['type' => 'submit', 'name' => 'delete', 'class' => 'btn btn-danger', 'value' => 'Delete']); ?>
                </div>
              </div>
